...
__laps_model = '/home/henry/workspace/neural_chessboard/data/models/laps.model.json'
__laps_weights = '/home/henry/workspace/neural_chessboard/data/models/laps.weights.h5'
